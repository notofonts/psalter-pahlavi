...
<details><summary><b>[16] NotoSansPsalterPahlavi-Regular.ttf</b></summary><div><details><summary>🔥 <b>FAIL:</b> Check Google Fonts glyph coverage. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/googlefonts.html#com.google.fonts/check/glyph_coverage">com.google.fonts/check/glyph_coverage</a>)</summary><div>
...
* 🔥 **FAIL** Entry [FONT_FAMILY_NAME(1):WINDOWS(3)] on the "name" table: Expected "Noto Sans Psalter Pahlavi" but got "Noto Sans PsaPahlavi". [code: mismatch]
...
* 🔥 **FAIL** OS/2.fsSelection bit 7 (USE_TYPO_METRICS) wasNOT set in the following fonts: ['fonts/NotoSansPsalterPahlavi/googlefonts/ttf/NotoSansPsalterPahlavi-Regular.ttf']. [code: missing-os2-fsselection-bit7]
</div></details><details><summary>🔥 <b>FAIL:</b> Checking OS/2 usWinAscent & usWinDescent. (<a href="https://font-bakery.readthedocs.io/en/stable/fontbakery/profiles/universal.html#com.google.fonts/check/family/win_ascent_and_descent">com.google.fonts/check/family/win_ascent_and_descent</a>)</summary><div>


* 🔥 **FAIL** OS/2.usWinAscent value should be equal or greater than 995, but got 737 instead [code: ascent]
...
* 🔥 **FAIL** On the 'name' table, the full font name 'Noto Sans Psalter Pahlavi Regular' does not begin with the font family name 'Noto Sans PsaPahlavi' in platformID 3, encodingID 1, languageID 1033(0409), and nameID 1. [code: mismatch-font-names]
...
* ⚠ **WARN** The following glyphs have colinear vectors:
	...
	* u10B84 (U+10B84): L<<439.0,304.0>--<423.0,479.0>> -> L<<423.0,479.0>--<423.0,480.0>>
	...
	* And u10B88 (U+10B88): L<<59.0,21.0>--<59.0,23.0>> -> L<<59.0,23.0>--<72.0,194.0>> [code: found-colinear-vectors]
